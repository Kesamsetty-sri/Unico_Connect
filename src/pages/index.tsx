    ...
    <>
      ...
      <div className={`min-h-screen ${theme === 'dark' ? 'bg-gray-900' : 'bg-gray-50'} text-gray-900 dark:text-gray-100 transition-colors duration-300`}>
        ...
        <main className="container mx-auto p-4">
          ...
          {isError && (
            <div className="text-center py-10 bg-red-100 dark:bg-red-900 border border-red-400 dark:border-red-700 text-red-700 dark:text-red-300 px-4 py-3 rounded relative" role="alert">
